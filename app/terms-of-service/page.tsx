    ...
    <div className="bg-gray-50 text-gray-800 p-8 md:p-16 min-h-screen">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <p>
          ...
          <a
            href="https://www.touchtapadventure.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500 underline"
          >
            https://www.touchtapadventure.com
          </a>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside">
            <li>
              ...
              <a
                target="_blank"
                href="mailto:support@touchtapadventure.com"
                className="text-blue-500 underline"
              >
                support@touchtapadventure.com
              </a>
            </li>
            <li>
              Website:{' '}
